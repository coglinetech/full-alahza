...
@section('title', 'Tambah Kuitansi - Admin')
...
@endpush
    ...
    <div class="page-header">
        <div>
            <h1>Form Cetak Kuitansi</h1>
            <p>Input data kuitansi dan lihat preview sebelum mencetak.</p>
        </div>
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:24px;">
        ...
        <div>
            <form id="receiptForm" method="POST" action="{{ route('admin.receipts.store') }}">
                @csrf
                <div class="form-grid" style="display:grid;grid-template-columns:1fr;gap:12px;">
                    <label class="form-group">
                        ...
                        <input type="text" id="receipt_number" name="receipt_number"
                            value="{{ old('receipt_number', $nextNumber ?? '') }}" readonly>
                    </label>
                    <label class="form-group">
                    ...
                    <label class="form-group">
                        ...
                        <input type="text" id="amount_text" name="amount_text" value="{{ old('amount_text') }}" required
                    ...
                    <label class="form-group">
                        ...
                        <input type="text" id="package_price" name="package_price" value="{{ old('package_price') }}"
                            oninput="handlePackageInput(event)">
                    </label>
                    <label class="form-group">
